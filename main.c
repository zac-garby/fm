...
int main() {
    ...
    player->bps = 2.0;
    player->song_parts[0].num_notes = 40;
    player->song_parts[0].notes = malloc(sizeof(fm_note) * 40);
    ...
    for (int s = 0; s < 20; s++) {
        ...
        player->song_parts[0].notes[3*s+1] = fm_make_note(1.5f * (200.0f + fmodf(100.0f * s, 325.0f)), s, 0.9f);
    }
